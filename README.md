...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Version-1.5.10-10B981?style=flat-square" alt="Version 1.5.10">
...
[**IdleDimmer-Setup-v1.5.10.exe**](https://github.com/UnDadFeated/IdleDimmer/releases/download/v1.5.10/IdleDimmer-Setup-v1.5.10.exe) — 280 KB
...
clang++ -O2 -std=c++17 -mwindows -Os -s -mguard=cf ^
    -o IdleDimmer-Setup-v1.5.10.exe ^
