...
REM
REM  Outputs:
REM     - dist\IdleDimmer_1.7.4.0_x64.msix       (unsigned, for Store)
REM     - dist\IdleDimmer_1.7.4.0_x64.msix      (self-signed, for sideload)
REM     - dist\IdleDimmer_1.7.4.0_x64.cer       (signing cert, for sideload)
REM ====================================================================
