...
cl.exe /nologo /O2 /MT /std:c++latest /EHsc /Fe:IdleDimmer.exe src\main.cpp src\MainWindow.cpp src\MainWindowDraw.cpp src\MainWindowInput.cpp src\DimmerManager.cpp src\ConfigManager.cpp resources\resources.res user32.lib gdi32.lib d2d1.lib dwrite.lib dwmapi.lib shell32.lib ole32.lib uuid.lib version.lib advapi32.lib comdlg32.lib winhttp.lib delayimp.lib /link /SUBSYSTEM:WINDOWS,10.0 /OSVERSION:10.0 /DYNAMICBASE /NXCOMPAT /GUARD:CF /HIGHENTROPYVA /DELAYLOAD:d2d1.dll /DELAYLOAD:dwrite.dll /DELAYLOAD:dwmapi.dll /DELAYLOAD:winhttp.dll /DELAYLOAD:comdlg32.dll /DELAYLOAD:version.dll
